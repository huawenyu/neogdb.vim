...
command! -nargs=1 GdbDebug  call gdb_expect#spawn(0, s:run_gdb_cmd.<q-args>, 0, 0, 1)
command! -nargs=1 GdbDebug1 call gdb_python#spawn(0, s:run_gdb_cmd.<q-args>, 0, 0, 1)
